...
subroutine triple2grid1_impl(kz, xi, yi, zi, zmsg, mx, ny, gx, gy, grid, domain, loop, method, distmx, mx2, ny2, &
...
end subroutine triple2grid1_impl
...
subroutine trip2grd2_impl(kz, x, y, z, zmsg, mx, ny, gxout, gyout, gout, mflag, nflag, method, ddcrit, ier)
    implicit none
...
subroutine trip2grd3_impl(kz, x, y, z, zmsg, mx, ny, gxout, gyout, gout, mflag, nflag, method, ddcrit, ier)
    implicit none
