!> @file vhaes.f90
!> @brief SPHEREPACK Vector harmonic analysis (even/odd sine) - OPTIMIZED for modern Fortran
...
contains
   ...
   !> @brief Main Vector harmonic analysis (even/odd sine) routine
   !> Optimized version of original SPHEREPACK vhaes
   subroutine vhaes(nlat, nlon, isym, nt, g, idg, jdg, a, b, mdab, ndab, &
   ...
   !> @brief Initialize workspace for Vector harmonic analysis (even/odd sine)
   subroutine vhaesi(nlat, nlon, wshags, lshags, dwork, ldwork, ierror)
