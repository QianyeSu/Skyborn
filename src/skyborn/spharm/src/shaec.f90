!> @file shaec.f90
!> @brief SPHEREPACK Spherical harmonic analysis (even/odd cosine) - OPTIMIZED for modern Fortran
...
contains
   ...
   !> @brief Main Spherical harmonic analysis (even/odd cosine) routine
   !> Optimized version of original SPHEREPACK shaec
   ...
   !> @brief Initialize workspace for Spherical harmonic analysis (even/odd cosine)
   subroutine shaeci(nlat, nlon, wshags, lshags, dwork, ldwork, ierror)
