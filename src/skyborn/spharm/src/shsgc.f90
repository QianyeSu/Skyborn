...
contains
   ...
   !> @brief Main Spherical harmonic synthesis (Gaussian cosine) routine
   !> Optimized version of original SPHEREPACK shsgc
   ...
   !> @brief Initialize workspace for Spherical harmonic synthesis (Gaussian cosine)
   subroutine shsgci(nlat, nlon, wshags, lshags, dwork, ldwork, ierror)
