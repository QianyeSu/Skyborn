...
contains
   ...
   !> @brief Main Vector harmonic synthesis (even/odd sine) routine
   !> Optimized version of original SPHEREPACK vhses
   subroutine vhses(nlat, nlon, isym, nt, g, idg, jdg, a, b, mdab, ndab, &
   ...
   !> @brief Initialize workspace for Vector harmonic synthesis (even/odd sine)
   subroutine vhsesi(nlat, nlon, wshags, lshags, dwork, ldwork, ierror)
