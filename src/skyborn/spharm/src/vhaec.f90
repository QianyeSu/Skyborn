!> @file vhaec.f90
!> @brief SPHEREPACK Vector harmonic analysis (even/odd cosine) - OPTIMIZED for modern Fortran
...
contains
   ...
   !> @brief Main Vector harmonic analysis (even/odd cosine) routine
   !> Optimized version of original SPHEREPACK vhaec
   subroutine vhaec(nlat, nlon, isym, nt, g, idg, jdg, a, b, mdab, ndab, &
   ...
   !> @brief Initialize workspace for Vector harmonic analysis (even/odd cosine)
   subroutine vhaeci(nlat, nlon, wshags, lshags, dwork, ldwork, ierror)
