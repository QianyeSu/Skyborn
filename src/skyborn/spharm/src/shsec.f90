...
contains
   ...
   !> @brief Main Spherical harmonic synthesis (even/odd cosine) routine
   !> Optimized version of original SPHEREPACK shsec
   ...
   !> @brief Initialize workspace for Spherical harmonic synthesis (even/odd cosine)
   subroutine shseci(nlat, nlon, wshags, lshags, dwork, ldwork, ierror)
