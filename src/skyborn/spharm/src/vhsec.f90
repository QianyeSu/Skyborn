!> @file vhsec.f90
!> @brief SPHEREPACK Vector harmonic synthesis (even/odd cosine) - OPTIMIZED for modern Fortran
...
contains
   ...
   !> @brief Main Vector harmonic synthesis (even/odd cosine) routine
   !> Optimized version of original SPHEREPACK vhsec
   subroutine vhsec(nlat, nlon, isym, nt, g, idg, jdg, a, b, mdab, ndab, &
   ...
   !> @brief Initialize workspace for Vector harmonic synthesis (even/odd cosine)
   subroutine vhseci(nlat, nlon, wshags, lshags, dwork, ldwork, ierror)
