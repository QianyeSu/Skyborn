!> @file vhsgs.f90
!> @brief SPHEREPACK Vector harmonic synthesis (Gaussian sine) - OPTIMIZED for modern Fortran
...
contains
   ...
   !> @brief Main Vector harmonic synthesis (Gaussian sine) routine
   !> Optimized version of original SPHEREPACK vhsgs
   subroutine vhsgs(nlat, nlon, isym, nt, g, idg, jdg, a, b, mdab, ndab, &
   ...
   !> @brief Initialize workspace for Vector harmonic synthesis (Gaussian sine)
   subroutine vhsgsi(nlat, nlon, wshags, lshags, dwork, ldwork, ierror)
