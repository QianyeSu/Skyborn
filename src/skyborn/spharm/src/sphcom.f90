...
module sphcom_mod
   ...
   real(wp), parameter :: SQRT2 = 1.4142135623730950488016887242096980785696718753769_wp
   real(wp), parameter :: SQRT3 = 1.7320508075688772935274463415058723669428052538104_wp
