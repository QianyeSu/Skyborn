!> @file vhsgc.f90
!> @brief SPHEREPACK Vector harmonic synthesis (Gaussian cosine) - OPTIMIZED for modern Fortran
...
contains
   ...
   !> @brief Main Vector harmonic synthesis (Gaussian cosine) routine
   !> Optimized version of original SPHEREPACK vhsgc
   subroutine vhsgc(nlat, nlon, isym, nt, g, idg, jdg, a, b, mdab, ndab, &
   ...
   !> @brief Initialize workspace for Vector harmonic synthesis (Gaussian cosine)
   subroutine vhsgci(nlat, nlon, wshags, lshags, dwork, ldwork, ierror)
