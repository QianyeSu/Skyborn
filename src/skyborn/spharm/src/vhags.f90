...
contains
   ...
   !> @brief Main Vector harmonic analysis (Gaussian sine) routine
   !> Optimized version of original SPHEREPACK vhags
   subroutine vhags(nlat, nlon, isym, nt, g, idg, jdg, a, b, mdab, ndab, &
   ...
   !> @brief Initialize workspace for Vector harmonic analysis (Gaussian sine)
   subroutine vhagsi(nlat, nlon, wshags, lshags, dwork, ldwork, ierror)
