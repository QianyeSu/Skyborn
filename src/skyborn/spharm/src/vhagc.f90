...
contains
   ...
   !> @brief Main Vector harmonic analysis (Gaussian cosine) routine
   !> Optimized version of original SPHEREPACK vhagc
   subroutine vhagc(nlat, nlon, isym, nt, g, idg, jdg, a, b, mdab, ndab, &
   ...
   !> @brief Initialize workspace for Vector harmonic analysis (Gaussian cosine)
   subroutine vhagci(nlat, nlon, wshags, lshags, dwork, ldwork, ierror)
