...
contains
   ...
   !> @brief Main Spherical harmonic synthesis (Gaussian sine) routine
   !> Optimized version of original SPHEREPACK shsgs
   ...
   !> @brief Initialize workspace for Spherical harmonic synthesis (Gaussian sine)
   subroutine shsgsi(nlat, nlon, wshags, lshags, dwork, ldwork, ierror)
