...
static PyMethodDef module_methods[] = {
    ...
    {"create_uv_to_vordiv_poa1_block_setup", backend_create_uv_to_vordiv_poa1_block_setup, METH_VARARGS, "Create a cached POA1-boundary uv-to-vordiv setup handle."},
    {"destroy_uv_to_vordiv_poa1_block_setup", backend_destroy_uv_to_vordiv_poa1_block_setup, METH_VARARGS, "Destroy a cached POA1-boundary uv-to-vordiv setup handle."},
    ...
    {"uv_to_vordiv_poa1_block_native_with_setup", backend_uv_to_vordiv_poa1_block_native_with_setup, METH_VARARGS, "Call the cached experimental ectrans POA1-boundary native uv-to-vordiv helper."},
